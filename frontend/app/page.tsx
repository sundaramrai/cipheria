  ...
  return (
    <main style={{ minHeight: '100dvh', display: 'flex', flexDirection: 'column', background: 'var(--bg)', position: 'relative' }}>
      ...
      <style>{`
        ...
        .nav-link-primary {
          background: var(--accent); color: #0a0908; font-weight: 600;
          letter-spacing: 0.02em; gap: 6px;
        }
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 9 }}>
          ...
          <span
            ...
            style={{ fontSize: 'clamp(1.15rem, 3vw, 1.35rem)', color: 'var(--text-primary)', lineHeight: 1 }}
          >
            Cipheria
          </span>
        </div>
      ...
      <section style={{
        ...
        textAlign: 'center',
        padding: 'clamp(56px, 12vw, 112px) 24px clamp(56px, 10vw, 96px)',
        position: 'relative',
      }}>
        {/* Decorative hairline rule above badge */}
        <div style={{
          width: 1, height: 48,
        ...
        >
          ...
          <br />
          <span style={{ color: 'var(--text-primary)', fontStyle: 'italic', opacity: 0.95 }}>
            forever yours.
          </span>
        </h1>
        ...
        <div
          className="animate-fade-up hero-ctas"
          style={{ display: 'flex', gap: 10, animationDelay: '240ms' }}
        >
          <Link
            ...
            style={{
              ...
              fontWeight: 600, padding: '13px 28px', borderRadius: 'var(--radius-md)',
        ...
        {/* Bottom rule */}
        <div style={{
          width: 1, height: 48, marginTop: 52,
      ...
      <section style={{
        ...
        padding: 'clamp(52px, 10vw, 88px) clamp(20px, 5vw, 48px)',
      }}>
        <div style={{ maxWidth: 1060, margin: '0 auto' }}>
          ...
          <div className="features-grid">
            {[
              {
                icon: Lock, title: 'AES-256-GCM',
                desc: 'Military-grade encryption derived from your master password — never stored, never sent.',
              },
              {
                icon: Zap, title: 'Instant Autofill',
                desc: 'Browser extension detects login forms and fills your credentials in a single click.',
              },
              {
                icon: Globe, title: 'Access Anywhere',
                desc: 'Syncs seamlessly across all your devices via a secure, serverless edge API.',
              },
              {
                icon: Shield, title: 'Zero Knowledge',
                desc: 'All encryption happens client-side. The server only ever sees ciphertext.',
              },
              {
                icon: RefreshCw, title: 'Password Generator',
                desc: 'Generate strong, random passwords with custom length and character rules.',
              },
              {
                icon: Download, title: 'Vault Export',
                desc: 'Download your entire vault as JSON anytime. Your data is always yours.',
              },
      ...
      <footer style={{
        ...
        <span style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>
          © 2026 · Open source · No ads · No tracking
        </span>
      </footer>
    </main>
  );
